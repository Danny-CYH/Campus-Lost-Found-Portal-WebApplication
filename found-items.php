                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div class="flex gap-2 pt-2">
                        <button id="mobile-apply-filters"
                            class="flex-1 bg-uum-green hover:bg-uum-blue text-white py-2 rounded-lg font-medium transition-colors">Apply
                            Filters</button>
                        <button id="mobile-clear-filters"
                            class="flex-1 bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 text-gray-700 dark:text-gray-300 py-2 rounded-lg font-medium transition-colors">Clear</button>
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div id="empty-state" class="hidden flex flex-col items-center justify-center py-16 text-center">
                ...
                <button id="reset-filters"
                    class="bg-uum-green hover:bg-uum-blue text-white px-6 py-3 rounded-xl font-medium transition-colors">Clear
                    All Filters</button>
            </div>
                ...
                <?php if (count($found_items) > 0): ?>
                    <?php foreach ($found_items as $item): ?>
                        <div class="item-card bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group"
                            ...
                            <div
                                class="relative h-48 bg-gradient-to-br from-yellow-100 to-yellow-200 dark:from-yellow-900 dark:to-yellow-800">
                                <div class="absolute top-3 right-3 z-10">
                                    <span
                                        class="bg-yellow-500 text-white px-2 py-1 rounded-full text-xs font-medium">Found</span>
                                </div>
                                ...
                                <div class="absolute bottom-3 left-3 z-10">
                                    ...
                                    ?>
                                    <i
                                        class="fas <?php echo $icon; ?> text-3xl text-yellow-600 dark:text-yellow-400 drop-shadow-md"></i>
                                </div>
                                ...
                                <div
                                    ...
                                    <a href="view-item.php?id=<?php echo $item['id']; ?>"
                                        class="view-item-btn opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 bg-white text-uum-green px-4 py-2 rounded-lg font-medium shadow-lg hover:bg-gray-50">View
                                        Details</a>
                                </div>
                            </div>
                            ...
                            <div class="p-4">
                                <div class="flex items-start justify-between mb-2">
                                    ...
                                    <span
                                        class="bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200 text-xs px-2 py-1 rounded-full whitespace-nowrap"><?php echo htmlspecialchars($item['category']); ?></span>
                                </div>
                                <p class="text-gray-600 dark:text-gray-400 text-sm mb-3 line-clamp-2">
                                    <?php echo htmlspecialchars($item['description']); ?>
                                </p>
                                <div class="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                                    <div class="flex items-center"><i class="fas fa-map-marker-alt mr-1"></i><span
